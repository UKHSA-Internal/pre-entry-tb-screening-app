  ...
  const summaryData = [
    {
      ...
      emptyValueMessage: "Enter whether a TB clearance certificate has been issued",
    },
    {
    ...
    },
    {
      ...
      emptyValueMessage: "Enter date of TB clearance certificate",
    },
    {
      ...
      emptyValueMessage: "Enter TB clearance certificate number",
    },
  ];
