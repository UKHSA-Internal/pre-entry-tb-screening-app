        ...
        <div className="govuk-summary-list__row">
          ...
          <dd className="govuk-summary-list__actions">
            <a
              ...
              style={{ color: "#1d70b8" }}
              onClick={() => navigate("/travel-details#visa-type")}
        ...
        <div className="govuk-summary-list__row">
          ...
          <dd className="govuk-summary-list__actions">
            <a
              className="govuk-link"
              style={{ color: "#1d70b8" }}
              onClick={() => navigate("/travel-details#address-1")}
              href="javascript:void(0);"
            >
        ...
        <div className="govuk-summary-list__row">
          ...
          <dd className="govuk-summary-list__actions">
            <a
              className="govuk-link"
              style={{ color: "#1d70b8" }}
              onClick={() => navigate("/travel-details#address-2")}
              href="javascript:void(0);"
            >
        ...
        <div className="govuk-summary-list__row">
          ...
          <dd className="govuk-summary-list__actions">
            <a
              className="govuk-link"
              style={{ color: "#1d70b8" }}
              onClick={() => navigate("/travel-details#town-or-city")}
              href="javascript:void(0);"
            >
        ...
        <div className="govuk-summary-list__row">
          ...
          <dd className="govuk-summary-list__actions">
            <a
              className="govuk-link"
              style={{ color: "#1d70b8" }}
              onClick={() => navigate("/travel-details#postcode")}
              href="javascript:void(0);"
            >
        ...
        <div className="govuk-summary-list__row">
          ...
          <dd className="govuk-summary-list__actions">
            <a
              className="govuk-link"
              style={{ color: "#1d70b8" }}
              onClick={() => navigate("/travel-details#mobile-number")}
              href="javascript:void(0);"
            >
        ...
        <div className="govuk-summary-list__row">
          ...
          <dd className="govuk-summary-list__actions">
            <a
              className="govuk-link"
              style={{ color: "#1d70b8" }}
              onClick={() => navigate("/travel-details#email")}
              href="javascript:void(0);"
            >
