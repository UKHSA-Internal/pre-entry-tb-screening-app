...
const ApplicantReview = () => {
  ...
  const summaryData = [
    ...
    },
    {
      ...
      link: `/visa-applicant-contact-information?from=check-visa-applicant-details#${attributeToComponentId.applicantHomeAddress1}`,
      hiddenLabel: "home address line 1",
    },
    {
      key: "Home address line 2 (optional)",
      value: applicantData.applicantHomeAddress2,
      link: `/visa-applicant-contact-information?from=check-visa-applicant-details#${attributeToComponentId.applicantHomeAddress2}`,
      hiddenLabel: "home address line 2",
    },
    {
      key: "Home address line 3 (optional)",
      value: applicantData.applicantHomeAddress3,
      link: `/visa-applicant-contact-information?from=check-visa-applicant-details#${attributeToComponentId.applicantHomeAddress3}`,
      hiddenLabel: "home address line 3",
    },
    {
      key: "Town or city",
      value: applicantData.townOrCity,
      link: `/visa-applicant-contact-information?from=check-visa-applicant-details#${attributeToComponentId.townOrCity}`,
      hiddenLabel: "home town or city",
    },
    {
      key: "Province or state",
      value: applicantData.provinceOrState,
      link: `/visa-applicant-contact-information?from=check-visa-applicant-details#${attributeToComponentId.provinceOrState}`,
      hiddenLabel: "home province or state",
    },
    {
      key: "Postcode",
      value: applicantData.postcode,
      link: `/visa-applicant-contact-information?from=check-visa-applicant-details#${attributeToComponentId.postcode}`,
