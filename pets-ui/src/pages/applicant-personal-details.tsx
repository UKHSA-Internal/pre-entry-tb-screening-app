...
export default function ApplicantPersonalDetailsPage() {
  ...
  useEffect(() => {
    sendGoogleAnalyticsJourneyEvent(
      "visa_applicant_personal_information",
      "UNK",
  ...
  return (
    <Container
      title="Visa applicant personal information - Complete UK pre-entry health screening - GOV.UK"
