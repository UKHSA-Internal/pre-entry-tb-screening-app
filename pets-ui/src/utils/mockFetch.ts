      ...
      if (queryParams.passportNumber === "007") {
        return {
          ...
          chestXrays: {
            ...
            posteroAnteriorXrayFile: "bucket-path or null if cxrTaken is No",
            apicalLordoticXray: true,
            apicalLordoticXrayFile: "bucket-path or null",
            lateralDecubitusXray: true,
            lateralDecubitusXrayFile: "bucket-path or null",
            reasonXrayWasNotTaken: "child",
            reasonXrayNotTakenDetail: "string or null",
            xrayWasNotTakenFurtherDetails: "explanation why chest x-ray was not taken",
