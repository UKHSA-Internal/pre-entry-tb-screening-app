...
describe("TC04: Display complete page structure correctly", () => {
  ...
  it("should display complete page structure correctly", () => {
    // AC3B: GIVEN I am on the "Check visa applicant photo" page
    ...
    checkPhotoPage
      .verifyCompletePageStructure()
      .verifyPhotoConfirmationFieldset()
      .verifyRulesLinkText();
  });
});
