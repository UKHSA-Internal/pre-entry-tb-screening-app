//PETS Scenario: Infant (1 month) - No Symptoms, No History, No Contact, No X-ray uploaded, Yes Sputum Required - TB Certificate Issued (6 months)
...
describe("PETS Scenario: Newborn Infant (1 month old) with No Symptoms, No X-ray, Sputum Required, Certificate Issued (6 months)", () => {
  ...
  it("should complete the full application process for 1-month-old newborn with no symptoms, no X-ray, sputum required, and issue certificate with 6 month expiry", () => {
    ...
    applicantSummaryPage.verifySummaryValue("Full name", "Baby Olivia Smith");
    ...
    clinicCertificateInfoPage
      ...
      .completeForm(
        ...
        "Newborn infant aged 1 month. No TB symptoms, history, or close contact. All sputum samples negative. Certificate issued with 6-month validity as no close contact with active TB.",
      );
