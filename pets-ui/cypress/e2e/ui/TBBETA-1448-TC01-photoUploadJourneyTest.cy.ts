...
describe("Photo Upload and Confirmation Journey - AC Tests", () => {
  ...
  it("should navigate to Check Photo page when photo is uploaded and Continue is clicked", () => {
    // AC1: GIVEN I have uploaded a photo in the "Upload visa applicant photo (optional)" page
    // WHEN I click the Continue button
    // THEN I am navigated to the "Check visa applicant photo" page
