...
describe("TBBETA-1586: Visa Category Radio Buttons Tests", () => {
  ...
  it("TC04: should display error message on visa category page when no selection is made", () => {
    ...
    visaCategoryPage.verifyPageHeading();
    visaCategoryPage.verifyFormGroup();
    visaCategoryPage.verifyFieldset();
    ...
    visaCategoryPage.verifyContinueButtonStyling();

    // Attempt to continue without selecting a visa category
    visaCategoryPage.clickContinue();

    // Verify error summary is displayed
    visaCategoryPage.validateErrorSummaryVisible();

    // Verify error summary title
    visaCategoryPage.validateErrorSummaryTitle("There is a problem");

    // Verify error summary contains the correct error text
    visaCategoryPage.validateErrorContainsText("Select visa category");

    // Verify error summary link exists and points to the field
    visaCategoryPage.validateErrorSummaryLink("Select visa category", "#visa-category");

    // Verify form group has error class
    visaCategoryPage.validateFormGroupError();

    // Verify field error message is displayed
    visaCategoryPage.validateVisaCategoryFieldError("Select visa category");

    // Verify user is still on the visa category page
