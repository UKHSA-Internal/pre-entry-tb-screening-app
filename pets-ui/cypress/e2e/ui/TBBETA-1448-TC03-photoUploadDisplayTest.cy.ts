...
describe("TC03: Display page with uploaded photo, filename and filesize", () => {
  ...
  it("should display the page in line with wireframe showing uploaded photo, filename and filesize", () => {
    // AC3A: GIVEN I am on the "Check visa applicant photo" page
    // THEN I see the page in line with the wireframe showing the uploaded photo, filename and filesize
    ...
    applicantDetailsPage
      ...
      .fillAddressLine1("789 Maple Drive")
      .fillAddressLine2("Unit 5C")
      .fillAddressLine3("Westside")
      .fillTownOrCity("Bridgetown")
      .fillProvinceOrState("Saint Michael")
      .selectAddressCountry(countryName)
      .fillPostcode("BB33333")
      .submitForm();
    ...
    checkPhotoPage
      .verifyPageLoaded()
      .verifyUploadedPhotoDisplayed()
      .verifyFilenameDisplayed()
      .verifyImageLayout()
      .verifyRadioButtonsExist()
      .verifyRadioButtonLabels();
  });
});
