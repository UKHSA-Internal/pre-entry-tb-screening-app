...
describe('TC07: Verify "rules for digital photos" link attributes', () => {
  ...
  it('should have correct link attributes for "rules for digital photos" to open in new tab', () => {
    // AC6A: GIVEN I am on the "Check visa applicant photo" page
    // WHEN I click the link "rules for digital photos (opens in new tab)"
    // THEN I am navigated to Get a passport photo in a new tab
    ...
    // Verify the passport photo rules link
    checkPhotoPage.verifyPassportPhotoRulesLink();

    // Verify the link has target="_blank" and correct href
