...
describe('TC05: Select "Yes, add this photo" and navigate to Check Details', () => {
  ...
  it('should navigate to Check Details page when "Yes, add this photo" is selected and Continue is clicked', () => {
    // AC4: GIVEN I am on the "Check visa applicant photo" page
    // AND have selected the "Yes, add this photo" radio button
    ...
    applicantDetailsPage
      ...
      .fillAddressLine1("555 Cedar Lane")
      .fillAddressLine2("Building A")
      .fillAddressLine3("Southside")
      .fillTownOrCity("Bridgetown")
      .fillProvinceOrState("Saint Michael")
      .selectAddressCountry(countryName)
      .fillPostcode("BB55555")
      .submitForm();
    ...
    // Select "Yes, add this photo" and continue
    checkPhotoPage.selectYesAddPhoto().verifyNoValidationErrors().clickContinue();

    // Verify we reach the check details page
